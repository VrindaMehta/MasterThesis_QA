...
set border 31 front lt black linewidth 4.000 dashtype solid
set zdata 
set ydata 
set xdata 
set y2data 
...
set key fixed right top vertical Right noreverse enhanced autotitle nobox font ",27"
...
set xtics  norangelimit autofreq  font ",27"
set ytics border in scale 1,0.5 mirror norotate  autojustify
set ytics  norangelimit autofreq  font ",27"
...
set xlabel "s" 
set xlabel  offset character 0, -2, 0 font ",27" textcolor lt -1 norotate
set x2label "" 
...
GNUTERM = "qt"
plot x w l lw 4 title "s", (1-x) lw 4 title "(1-s)"
#    EOF
